...
int main()
{
	...
	glUniform1i(glGetUniformLocation(lightingShader.Program, "Material.shininess"), 2.0f);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		if (active) {
			glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[0].ambient"), 0.20f, 0.20f, 0.10f);
			glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[0].diffuse"), 0.15f, 0.15f, 0.10f);
